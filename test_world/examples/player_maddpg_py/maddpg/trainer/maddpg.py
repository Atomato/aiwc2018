...
class MADDPGAgentTrainer(AgentTrainer):
    ...
    def update(self, agents, t):
        ...
        target_q /= num_sample
        self.printConsole('agent index: ' + str(self.agent_index))
        self.printConsole('update error?')
        # self.printConsole(str(obs_n + act_n + [target_q]))
        self.printConsole('obs' + str(obs_n))
        self.printConsole('act' + str(act_n))
        self.printConsole('target q' + str([target_q]))
        # self.printConsole(type(target_q))

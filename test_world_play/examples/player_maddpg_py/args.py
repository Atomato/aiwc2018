class Argument(object):
	def __init__(self):
		# Environment
		self.scenario = "simple" # name of the scenario script
		...
		self.load_dir = "./save_model/reward_100/aiwc_maddpg" # directory in which training state and model are loaded
		# Evaluation
		self.restore = True
		self.display = False

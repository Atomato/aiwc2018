...
##############################################################################
        ...
        def avoid_deadlock(self):
            ...
            if (self.distances[MY_TEAM][self.idxs[MY_TEAM][0]] > 0.13) or (self.avoid_deadlock_cnt > 20):
...
##############################################################################
            ...
            # self.printConsole("robot " + str(self.idxs[MY_TEAM][0]) + " distance: " + str(self.distances[MY_TEAM][self.idxs[MY_TEAM][0]]))
            # self.printConsole("  robot " + str(self.idxs[MY_TEAM][1]) + " distance: " + str(self.distances[MY_TEAM][self.idxs[MY_TEAM][1]]))
            # self.printConsole("    robot " + str(self.idxs[MY_TEAM][2]) + " distance: " + str(self.distances[MY_TEAM][self.idxs[MY_TEAM][2]]))
            # self.printConsole("      robot " + str(self.idxs[MY_TEAM][3]) + " distance: " + str(self.distances[MY_TEAM][self.idxs[MY_TEAM][3]]))
            # self.printConsole("        robot " + str(self.idxs[MY_TEAM][4]) + " distance: " + str(self.distances[MY_TEAM][self.idxs[MY_TEAM][4]]))            
            ...
            # self.printConsole("theta: " + str(helper.radian2degree(self.cur_my_posture[4][TH])))
